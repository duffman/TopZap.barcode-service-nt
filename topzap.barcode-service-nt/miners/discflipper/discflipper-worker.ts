...
import {Convert, WeBuyGamesBasketResult, WeBuyGamesResult, WeBuyGamesSignResult} from "./discflipper-data";
...
export class DiscFlipperWorker implements IZapMinerCore {
	baseRequest: request;
	 ...
	 */
	public async search(ean: string, sign: WeBuyGamesSignResult = null): Promise<WeBuyGamesResult> {
		if (!sign === null) {
